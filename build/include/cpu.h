...
typedef struct registers {
  ...
  uint8_t *l;
  uint8_t flag; /* ZNHC.... */
  uint8_t interrupt_enable_flag; /* VLTSP... */
  uint8_t stored_interrupt_enable_flag; /* VLTSP... */
  uint8_t interrupt_request_flag; /* VLTSP... */
...
enum reg_enum { _A, _B, _C, _D, _E, _F, _H, _L, _1, _IMM, _ };
